...
! function(a) {
    ...
    if (b.DEFAULTS = {
            initOnClick: !1,
            pluginsEnabled: null
        }, b.MODULES = {}, b.PLUGINS = {}, b.VERSION = "2.4.1", b.INSTANCES = [], b.OPTS_MAPPING = {}, b.SHARED = {}, b.ID = 0, b.prototype._init = function() {
                ...
                for (var g = d(), e = 0; e < c.length; e++) {
                    ...
                    if (k.length > 0) {
                        ...
                        try {
                            ...
                            if (!n) {
                                var w, x;
                                if ((b.browser.chrome || b.browser.edge) && i.nextSibling == k) w = m(k, j, !0) || j.setStartAfter(k), x = m(i, j, !1) || j.setEndBefore(i);
                                else {
            ...
            function C(a, c) {
                ...
                if (!b.opts.useClasses && !c) {
                    ...
                    for (e = 0; e < f.length; e++)
                        if (f[e].getAttribute("class") && (f[e].setAttribute("fr-original-class", f[e].getAttribute("class")), f[e].removeAttribute("class")), (f[e].getAttribute("fr-original-style") || "").trim().length > 0)
                            for (var v = f[e].getAttribute("fr-original-style").split(";"), p = 0; p < v.length; p++) v[p].indexOf(":") > 0 && (f[e].style[v[p].split(":")[0].trim()] = v[p].split(":")[1].trim())
                }
                if (b.core.isEmpty() ? b.opts.fullPage && (d = q(b.iframe_document), d += "<html" + b.node.attributes(b.$html.get(0)) + ">" + b.$html.find("head").get(0).outerHTML + "<body></body></html>") : ("undefined" == typeof a && (a = !1), b.opts.fullPage ? (d = q(b.iframe_document), b.$el.removeClass("fr-view"), d += "<html" + b.node.attributes(b.$html.get(0)) + ">" + b.$html.html() + "</html>", b.$el.addClass("fr-view")) : d = b.$el.html()), !b.opts.useClasses && !c)
                    for (e = 0; e < f.length; e++) f[e].getAttribute("fr-original-class") && (f[e].setAttribute("class", f[e].getAttribute("fr-original-class")), f[e].removeAttribute("fr-original-class")), f[e].getAttribute("fr-original-style") ? (f[e].setAttribute("style", f[e].getAttribute("fr-original-style")), f[e].removeAttribute("fr-original-style")) : f[e].removeAttribute("style");
                b.opts.fullPage && (d = d.replace(/<style data-fr-style="true">(?:[\w\W]*?)<\/style>/g, ""), d = d.replace(/<link([^>]*)data-fr-style="true"([^>]*)>/g, ""), d = d.replace(/<style(?:[\w\W]*?)class="firebugResetStyles"(?:[\w\W]*?)>(?:[\w\W]*?)<\/style>/g, ""), d = d.replace(/<body((?:[\w\W]*?)) spellcheck="true"((?:[\w\W]*?))>((?:[\w\W]*?))<\/body>/g, "<body$1$2>$3</body>"), d = d.replace(/<body((?:[\w\W]*?)) contenteditable="(true|false)"((?:[\w\W]*?))>((?:[\w\W]*?))<\/body>/g, "<body$1$3>$4</body>"), d = d.replace(/<body((?:[\w\W]*?)) dir="([\w]*)"((?:[\w\W]*?))>((?:[\w\W]*?))<\/body>/g, "<body$1$3>$4</body>"), d = d.replace(/<body((?:[\w\W]*?))class="([\w\W]*?)(fr-rtl|fr-ltr)([\w\W]*?)"((?:[\w\W]*?))>((?:[\w\W]*?))<\/body>/g, '<body$1class="$2$4"$5>$6</body>'), d = d.replace(/<body((?:[\w\W]*?)) class=""((?:[\w\W]*?))>((?:[\w\W]*?))<\/body>/g, "<body$1$2>$3</body>")), b.opts.htmlSimpleAmpersand && (d = d.replace(/\&amp;/gi, "&")), b.events.trigger("html.afterGet"), a || (d = d.replace(/<span[^>]*? class\s*=\s*["']?fr-marker["']?[^>]+>\u200b<\/span>/gi, "")),
                    d = b.clean.invisibleSpaces(d), d = b.clean.exec(d, B);
            ...
            function H(a, c, d) {
                b.selection.isCollapsed() || b.selection.remove();
                var e;
                if (e = c ? a : b.clean.html(a), e = e.replace(/\r|\n/g, " "), a.indexOf('class="fr-marker"') < 0 && (e = F(e)), b.core.isEmpty() && !b.opts.keepFormatOnDelete) b.el.innerHTML = e;
                else {
                    var f = b.markers.insert();
                    if (f) {
            ...
            function f(a) {
                a = a.replace(/<p(.*?)class="?'?MsoListParagraph"?'? ([\s\S]*?)>([\s\S]*?)<\/p>/gi, "<ul><li>$3</li></ul>"), a = a.replace(/<p(.*?)class="?'?NumberedText"?'? ([\s\S]*?)>([\s\S]*?)<\/p>/gi, "<ol><li>$3</li></ol>"),
            ...
            function h() {
                ...
                if (b.opts.pastePlain && (m = g(m)), d = b.events.chainTrigger("paste.afterCleanup", m), "string" == typeof d && (m = d), "" !== m) {
                    ...
                    var r = l.children;
                    if (1 == r.length && ["OL", "UL"].indexOf(r[0].tagName) >= 0 && (r[0].outerHTML = r[0].innerHTML), !h)
                ...
                return {
                    ...
                    _repositionPopup: function(a) {
                        ...
                        if (b.$wp && f(c) && d.parent().get(0) == b.$sc.get(0)) {
                            var e = d.offset().top - b.$wp.offset().top,
                                g = b.$wp.outerHeight();
            ...
            toolbarButtons: ['fullscreen', 'bold', 'italic', 'underline', 'strikeThrough', 'subscript', 'superscript', '|', 'fontFamily', 'fontSize', 'color', 'inlineClass', 'inlineStyle', 'paragraphStyle', 'lineHeight', '|', 'align', 'formatOL', 'formatUL', 'outdent', 'indent', '-', 'insertLink', 'insertImage', 'insertVideo', 'embedly', 'insertFile', 'insertTable', '|','paragraphFormat','quote', 'emoticons', 'fontAwesome', 'specialCharacters', 'insertHR', 'selectAll', 'clearFormatting', '|', 'print', 'getPDF', 'spellChecker', 'help', 'html', '|', 'undo', 'redo'],
            ...
            function h(c, d) {
                setTimeout(function() {
                    ...
                    else if (b.selection.inEditor() && b.core.hasFocus() && !b.popups.areVisible() && (b.opts.toolbarVisibleWithoutSelection || !b.selection.isCollapsed() && !b.keys.isIME() || d)) {
            ...
            function t(a) {
                if (b.node.hasClass(a, "fr-file")) return b.events.trigger("file.unlink", [a])
            }
            ...
            function w() {
                B = y.find("#fr-preloader"), C = y.find("#fr-image-list"), D = y.find("#fr-modal-tags"), I = e(), f(), z.css("height", z.find(".fr-modal-head-line").outerHeight()), b.events.$on(a(b.o_win), "resize", function() {
                    ...
                    b.events.bindClick(y, "i#fr-modal-more-" + b.sid, s), b.events.bindClick(D, "a", u)
            }
    ...
    a.FE.DEFAULTS.imageInsertButtons.push("imageManager"), a.FE.RegisterCommand("imageManager", {
            ...
            a.shared.print_iframe ? c = a.shared.print_iframe : (c = document.createElement("iframe"), c.name = "fr-print", c.style.position = "fixed", c.style.top = "0", c.style.left = "-9999px", c.style.height = "100%", c.style.width = "0", c.style.overflow = "hidden", c.style["z-index"] = "9999", c.style.tabIndex = "-1", document.body.appendChild(c), c.onload = function() {
                setTimeout(function() {
                    a.events.disableBlur(),
                        window.frames["fr-print"].focus(), window.frames["fr-print"].print(), a.$win.get(0).focus(), a.events.disableBlur(), a.events.focus()
                }, 0)
        ...
        function s() {
            ...
            if (c.length > 0)
                ...
                else if (c.remove(), ra().length > 0) d();
            else {
        ...
        function Q(c, d) {
            if (a(c).is(d)) L(), b.edit.on(), a(c).addClass("fr-selected-cell");
            else {
                M(), b.edit.off();
                var e = I(),
                    f = J(c, e),
        ...
        function T(c) {
            var d = R(c);
            if (ra().length > 0 && !d && S(), !b.edit.isDisabled() || b.popups.isVisible("table.edit"))
                if (1 != c.which || 1 == c.which && b.helpers.isMac() && c.ctrlKey)(3 == c.which || 1 == c.which && b.helpers.isMac() && c.ctrlKey) && d && S();
                else if (za = !0, d) {
        ...
        function ca(c, d) {
            var e = a(d),
                f = e.closest("table"),
                g = f.parent();
            if (d && "TD" != d.tagName && "TH" != d.tagName && (e.closest("td").length > 0 ? d = e.closest("td") : e.closest("th").length > 0 && (d = e.closest("th"))), !d || "TD" != d.tagName && "TH" != d.tagName) wa && e.get(0) != wa.get(0) && e.parent().get(0) != wa.get(0) && b.core.sameInstance(wa) && aa();
            else {
        ...
        function ia() {
            var c = wa.data("origin"),
                d = wa.data("release-position");
            if (c !== d) {
                var e = wa.data("first"),
                    f = wa.data("second"),
                    g = wa.data("table"),
        ...
        function la(a) {
            if (ra().length > 1 && za && M(), za === !1 && ya === !1 && Ca === !1) Ba && clearTimeout(Ba), b.edit.isDisabled() && !b.popups.isVisible("table.edit") || (Ba = setTimeout(ga, 30, a));
            else if (Ca) {
                var c = a.pageX - b.win.pageXOffset;
                b.opts.iframe && (c += b.$iframe.offset().left);
                var d = wa.data("max-left"),
                    e = wa.data("max-right");
        ...
        function na(c) {
            ...
            if (d == a.FE.KEYCODE.TAB) {
                var e;
                if (ra().length > 0) e = b.$el.find(".fr-selected-cell:last");
                else {
        ...
        function oa() {
            b.shared.$ti_helper || (b.shared.$ti_helper = a('<div class="fr-insert-helper"><a class="fr-floating-btn" role="button" tabIndex="-1" title="' + b.language.translate("Insert") + '"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M22,16.75 L16.75,16.75 L16.75,22 L15.25,22.000 L15.25,16.75 L10,16.75 L10,15.25 L15.25,15.25 L15.25,10 L16.75,10 L16.75,15.25 L22,15.25 L22,16.75 Z"/></svg></a></div>'), b.events.bindClick(b.shared.$ti_helper, "a", function() {
                var a = xa.data("selected-cell"),
                    c = xa.data("position"),
                    d = xa.data("instance") || b;
        ...
        function f(a) {
            ...
            var g = "";
            b.opts.videoInsertButtons.indexOf("videoUpload") >= 0 && (g = '<div class="fr-video-upload-layer fr-layer" id="fr-video-upload-layer-' + b.id + '"><strong>' + b.language.translate("Drop video") + "</strong><br>(" + b.language.translate("or click") + ')<div class="fr-form"><input type="file" accept="video/' + b.opts.videoAllowedTypes.join(", video/").toLowerCase() + '" tabIndex="-1" aria-labelledby="fr-video-upload-layer-' + b.id + '" role="button"></div></div>');
            var h = '<div class="fr-video-progress-bar-layer fr-layer"><h3 tabIndex="-1" class="fr-message">Uploading</h3><div class="fr-loader"><span class="fr-progress"></span></div><div class="fr-action-buttons"><button type="button" class="fr-command fr-dismiss" data-cmd="videoDismissError" tabIndex="2" role="button">OK</button></div></div>',
                i = {
                    buttons: d,
                    by_url_layer: e,
                    embed_layer: f,
                ...
                j = b.popups.create("video.insert", i);
            return Q(j), j
        }
        ...
        function B(c) {
            ...
            return !(!d || !e) && (b.undo.canDo() || b.undo.saveStep(), pa = a(this), pa.data("start-x", d), pa.data("start-y", e), oa.show(), b.popups.hideAll(), void M())
        }
        ...
        function O(c, d, e) {
            function f() {
                var e = a(this);
                e.off("canplay"), e.addClass("fr-uploading"), e.parent().next().is("br") && e.parent().next().remove(), b.placeholder.refresh(), e.parent().is(ra) || t(e.parent()), I(), n(), b.edit.off(), c.onload = function() {
                    w.call(c, e.parent())
                }, c.onerror = x, c.upload.onprogress = y, c.onabort = z, e.off("abortUpload").on("abortUpload", function() {
                    4 != c.readyState && c.abort()
                }), c.send(d)
            }
            var g, h = new FileReader;
            h.addEventListener("load", function() {
                for (var a = h.result, c = atob(h.result.split(",")[1]), d = [], e = 0; e < c.length; e++) d.push(c.charCodeAt(e));
                if (a = window.URL.createObjectURL(new Blob([new Uint8Array(d)], {
                        type: "video/mp4"
                    })), ra) {
                    ra.data("fr-replaced", !0);
                    var i = ra.find("video");
                    i.length ? (i.on("canplay", f), b.edit.on(), b.undo.saveStep(), i.data("fr-old-src", i.attr("src")), i.attr("src", a)) : (da(), g = A(a, null, f))
                } else g = A(a, null, f)
            }, !1), h.readAsDataURL(e)
        }
        ...
        function Q(c) {
            b.events.$on(c, "dragover dragenter", ".fr-video-upload-layer", function() {
                ...
                return a(this).removeClass("fr-drop"), !1
            }), b.events.$on(c, "drop", ".fr-upload-upload-layer", function(d) {
                d.preventDefault(), d.stopPropagation(), a(this).removeClass("fr-drop");
                var e = d.originalEvent.dataTransfer;
                if (e && e.files) {
                    var f = c.data("instance") || b;
        ...
        function R() {
            b.events.on("mousedown window.mousedown", L), b.events.on("window.touchmove", M), b.events.on("mouseup window.mouseup", K), b.events.on("commands.mousedown", function(a) {
