	...
	<script>
		...
		$(document).ready(function() {
			$('#table').dataTable({
		        "ajax": "<?=base_url();?>personal/personal_list/<?=$this->uri->segment(5)?>",
		        "iDisplayLength" : 50,
		        "scrollX": true,
		        "columns": [          
		            ...
		            { "data":function(data){
						return '<a href="<?=base_url()?>personal/view/'+remove_spc(data.title)+'/'+data.id+'">'+data.title+'</a>';
		            } },
		            { "data":function(data){
