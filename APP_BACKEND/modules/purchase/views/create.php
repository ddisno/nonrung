  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class=""><a href="<?=base_url();?>download"> จัดซื้อจัดจ้าง</a></li>
  ...
  <script type="text/javascript">
    $(function(){
        ...
        $('#text').froalaEditor({
          ...
          heightMax: 400,
          // image
          imageUploadURL:"<?=base_url();?>download/upload",
          ...
          imageManagerLoadURL:"<?=base_url();?>download/select",
          imageManagerDeleteURL:"<?=base_url();?>download/delete",
          imageManagerDeleteMethod:"POST",
          // video
          videoUploadURL: '<?=base_url();?>download/upload',
          ...
          // fileupload
          fileUploadURL: '<?=base_url();?>download/upload',
