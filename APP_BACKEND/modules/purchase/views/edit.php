...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       <?=$header?>
        <a class="btn btn-primary" href="<?=base_url();?>purchase"><i class="fa fa-list"></i> จัดการจัดซื้อจัดจ้าง</a>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?=base_url();?>"><i class="fa fa-dashboard"></i> แดชบอร์ด</a></li>
        <li class=""><a href="<?=base_url();?>purchase">จัดซื้อจัดจ้าง</a> </li>
              ...
              <div class="box-body" style="padding: 0;">
                <div class="nav-tabs-custom" style="margin-bottom: 0">
                  <ul class="nav nav-tabs">
                    <li class="active">
                      <a href="#th" data-toggle="tab"><img src="<?=$this->config->item('vendor')?>img/th_fl.jpg" width="25" height="15"> เนื้อหาจัดซื้อจัดจ้าง</a>
                    </li>
                  </ul>
  ...
  <script type="text/javascript">
    $(function(){
        $('#text').froalaEditor({
          ...
          heightMax: 400,
          // image
          imageUploadURL:"<?=base_url();?>purchase/upload",
          ...
          imageManagerLoadURL:"<?=base_url();?>purchase/select",
          imageManagerDeleteURL:"<?=base_url();?>purchase/delete",
          imageManagerDeleteMethod:"POST",
          // video
          videoUploadURL: '<?=base_url();?>purchase/upload',
          ...
          // fileupload
          fileUploadURL: '<?=base_url();?>purchase/upload',
