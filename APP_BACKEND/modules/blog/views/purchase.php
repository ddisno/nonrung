<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
      <a class="btn btn-success" href="<?=base_url();?>blog/create/purchase">เพิ่มข่าวสาร</a>
      <a class="btn btn-primary" href="<?=base_url();?>blog/sticky/purchase">รายการที่ปักหมุด</a>
  ...
  <script type="text/javascript">
    $(function(){
      ...
      function cb(start='', end='') { 
        ...
        if(start==''){
          table.ajax.url('<?=base_url()?>blog/blog_list/3').load();   
          ...
          table.ajax.url('<?=base_url()?>blog/blog_list/3/?'+$('#daterange').serialize()).load(); 
        }     
      }
