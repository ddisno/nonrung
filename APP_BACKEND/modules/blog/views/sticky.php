<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
      <a class="btn btn-success" href="<?=base_url();?>blog/create/<?=$this->uri->segment(3)?>">เพิ่มข่าวสาร</a>
      <a class="btn btn-primary" href="<?=base_url();?>blog/<?=$this->uri->segment(3)?>">รายการทั้งหมด</a>
  ...
  <script type="text/javascript">
    $(function(){
      ...
      var table = $('#table').DataTable( {
        "ajax": "<?=base_url();?>blog/blog_list_stick/<?=$id_cat?>",
        "iDisplayLength" : 50,
        "scrollX": true,
        "columns": [          
