                      ...
                      <div class="form-group" style="margin-bottom: 0">
                        ...
                        <div class="col-sm-11" style="padding: 0">
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="name_th" placeholder="Header.." required name="name_th">
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                        <label>เนื้อหาย่อ</label>
                        <textarea name="para_th" class="form-control" rows="5"></textarea>
                      </div>
                      <label>เนื้อหา</label>
                      <textarea id="text_th" name="text_th"></textarea>
                    </div>
                    <div class="tab-pane" id="en">
                      <div class="form-group" style="margin-bottom: 0">
                        ...
                        <div class="col-sm-11" style="padding: 0">
                          <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-header"></i></span>
                            <input type="text" class="form-control" id="name_en" placeholder="Header.." name="name_en">
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                        <label>เนื้อหาย่อ</label>
                        <textarea name="para_en" class="form-control" rows="5"></textarea>
                      </div>
                      <label>เนื้อหา</label>
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body" style="">
                    <div style="width: 100%; padding-bottom: 10px;">
                        <img id='img-upload' src="<?=$this->config->item('vendor')?>img/no_img_sq.jpg" />
                    </div>
                    <div class="input-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <select class="form-control" id="category" name="category">
                          <?php
                            if($this->uri->segment(3)=='municipal_news'){
                              $id_cat = 1;
                            }elseif($this->uri->segment(3)=='other_news'){
                              $id_cat = 2;
                            }elseif($this->uri->segment(3)=='purchase'){
                              $id_cat = 3;
                            }else{
                              $id_cat = 4;
                            }
                          ...
                          ?>
                              <option value="<?=$cat['id_cat']?>"
                                <?=($this->uri->segment(3)!='')?($id_cat==$cat['id_cat'])?'seleted':'disabled':'';?>
                              >
                                <?=$cat['name_cat_th']?>
                              </option>
                          <?php
  ...
  <script type="text/javascript">
    ...
    $('#create').submit(function(event) {
      ...
      if($('#category').val()==undefined){
        swal('คำเตือน', 'กรุณาสร้างหมวดหมู่ก่อนการสร้างบล็อก', 'warning');
        return false;
      }
      swal({
          title: 'ยืนยัน',
            ...
            return new Promise(function (resolve) {
              $.ajax({
                ...
                success:function(data){
                  console.log(data);
                  if(data == 'success'){
                    swal('สำเร็จ', 'เพิ่มข้อความเรียบร้อยแล้ว', 'success');
                  }else{
