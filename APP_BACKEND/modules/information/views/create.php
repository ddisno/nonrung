              ...
              <div class="box-body" style="padding: 0;">
                <div class="nav-tabs-custom" style="margin-bottom: 0">
                  <ul class="nav nav-tabs">
                    <li class="active">
                      <a href="#th" data-toggle="tab"><img src="<?=$this->config->item('vendor')?>img/th_fl.jpg" width="25" height="15"> เนื้อหางบประมาณ</a>
                    </li>
  ...
  <script type="text/javascript">
    $(function(){
        ...
        $('#text').froalaEditor({
          ...
          heightMax: 400,
          // image
          imageUploadURL:"<?=base_url();?>ita/upload",
          ...
          imageManagerLoadURL:"<?=base_url();?>ita/select",
          imageManagerDeleteURL:"<?=base_url();?>ita/delete",
          imageManagerDeleteMethod:"POST",
          // video
          videoUploadURL: '<?=base_url();?>ita/upload',
          ...
          // fileupload
          fileUploadURL: '<?=base_url();?>ita/upload',
