...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       <?=$header?>
       <a class="btn btn-primary" href="<?=base_url();?>budget"><i class="fa fa-list"></i> จัดการงบประมาณ</a>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?=base_url()?>"><i class="fa fa-dashboard"></i> แดชบอร์ด</a></li>
        <li class=""><a href="<?=base_url();?>budget"> งบประมาณ</a></li>
  ...
  <script type="text/javascript">
    $(function(){
        ...
        $('#text').froalaEditor({
          ...
          heightMax: 400,
          // image
          imageUploadURL:"<?=base_url();?>budget/upload",
          ...
          imageManagerLoadURL:"<?=base_url();?>budget/select",
          imageManagerDeleteURL:"<?=base_url();?>budget/delete",
          imageManagerDeleteMethod:"POST",
          // video
          videoUploadURL: '<?=base_url();?>budget/upload',
          ...
          // fileupload
          fileUploadURL: '<?=base_url();?>budget/upload',
