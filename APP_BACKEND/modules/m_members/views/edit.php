  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <input type="hidden" name="id_member" value="<?=$this->uri->segment(3)?>">
        <!-- staff list -->
        <div class="col-md-6">
          <div class="row">
            <!-- ข้อมูลทั่วไปร -->
                      ...
                      <div class="form-group">
                        <div class="col-sm-12">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Fisrtname" name="f_name" value="<?=$member['f_name']?>">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-12">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Lastname" name="l_name" value="<?=$member['l_name']?>">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-sm-12">
                          ...
                          <div class="input-group">
                            ...
                            <input type="Telephone" class="form-control" placeholder="091-882XXXX" name="phone" value="<?=$member['phone']?>">
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-12">
                          ...
                          <div class="input-group">
                            ...
                            <input type="Email" class="form-control" placeholder="example@yourmail.com" name="email" value="<?=$member['email']?>">
                          </div>
                          <?=form_error('email','<div class="text-red">', '</div>')?>
                        </div>
                      </div>
                      <div class="box box-default <?=(form_error('password') || form_error('passconf'))?'':'collapsed-box'?> box-solid">
                        <div class="box-header with-border">
                          <h3 class="box-title">เปลี่ยนรหัสผ่านใหม่</h3>
                          ...
                          <div class="input-group">
                            ...
                            <select class="form-control"
                              ...
                              foreach ($roles as $role) {
                                ?>
                                <option value="<?=$role['id_role']?>" <?=($member['id_role']==$role['id_role'])?'selected':'';?>><?=$role['name_role']?></option>
                                <?php
                              }
                              ?>
                            </select>
                        ...
                        <div class="col-sm-12">
                          ...
                          <div class="input-group">
                            ...
                            <select class="form-control" name="status">
                              <option value="active" <?=($member['status']=='active')?'selected':'';?>>พร้อมใช้งาน</option>
                              <option value="inactive" <?=($member['status']=='inactive')?'selected':'';?>>ไม่พร้อมใช้งาน</option>
                            </select>
                          </div>
                        </div>
                      </div>
